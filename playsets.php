...
<!-- End Global Meta -->
<title>Backyard Adventures Idaho| Playsets</title>
		...
		<section class="bya-playsets">
			<div class="wrapper mtm">
				<div class="gd-row gt-row">
					<div class="gd-third gd-columns gt-half gt-columns">
						<img src="http://placehold.it/440x440">
					</div>
					<div class="gd-two-thirds gd-columns gt-half gt-columns">
						<div class="content-container">
							<h3 class="paragon-text mtn">Playsets</h3>
